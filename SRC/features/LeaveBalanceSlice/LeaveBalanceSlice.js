...
const LeaveBalanceSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(LeaveBalanceAction.pending, state => {
      state.isLoading = true;
    });
    builder.addCase(LeaveBalanceAction.rejected, state => {
      state.isLoading = false;
    });
    builder.addCase(LeaveBalanceAction.fulfilled, (state, action) => {
      state.isLoading = false;
...
export const {clearAllState} = LeaveBalanceSlice.actions;
